...
/**
 * Servlet implementation class UniversityLogin
 */
@WebServlet("/UniversityLogin")
public class UniversityLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(uid.equalsIgnoreCase("admin")&&pwd.equalsIgnoreCase("admin"))
			{
			response.sendRedirect("UniversityHome.jsp");
		}else{
			o.println("<script type=\"text/javascript\">");
			o.println("alert('Please enter valid Details');");
			o.println("window.location='UniversityLogin.jsp';</script>");
		}
	}
}
