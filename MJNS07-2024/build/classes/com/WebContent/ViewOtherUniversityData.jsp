...
<head>
                        ...
                        <div class="navigation-wrapper pull-left">
                            <div class="navigation pull-left">
                            	<ul>
                                    ...
                                    <li><a href="ViewUniversityData.jsp">View University Data</a></li>
                                    <li><a href="ViewOtherUniversityData.jsp">View Other University Data</a></li>
    ...
    .form-box {
        background-color: #3a3f47; /* Slightly lighter background for the form */
        padding: 30px;
        border-radius: 10px;
    ...
    .data-table tbody tr:hover {
        background-color: #0056b3; /* Row hover color */
    }

    .data-table td {
        color: white; /* Table data text color */
        font-size: 16px;
    }
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12">
                <div class="form-box">
                    <h1 class="mb-4 text-center">View Other University <br><span>Data</span></h1>
                    <%
                        session = request.getSession(false);
                        String user = (String) session.getAttribute("email");
                        String name = "select university1 from rcollege where cname ='" + user + "' ";
                        String university = DBConnection.getName(name);
                        String sql = "select cname='" + user + "' from rcollege where university1='" + university + "' and status1 !='Approved'";
                        List<String> lt = DBConnection.getUnversity(sql);
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <%
                                ...
                                String name1 = "select university1 from rcollege where cname ='" + user1 + "' ";
                                String university1 = DBConnection.getName(name);
                                sql = "select * from gnit where universityname !='" + university1 + "'";
                                List<String> lt1 = DBConnection.getUName(sql);
                                Iterator<String> itr1 = lt1.iterator();
                                ResultSet r = DBConnection.getCollegeInfo();
                                while (r.next()) {
                                    while (itr1.hasNext()) {
                            %>
                                <tr>
                                    ...
                                    <td><%= itr1.next() %></td>
                                    <td><%= itr1.next() %></td>
                                    <td><a href="ViewOtherFiles?fid=<%= university1 %>" class="view-file">View</a></td>
                                    <td><%= itr1.next() %></td>
                                    <td><%= itr1.next() %></td>
                                </tr>
                            <%
