                    ...
                    <div class="iq_ui_element">
                        ...
                        <div class="navigation-wrapper pull-left">
                            <div class="navigation pull-left">
                            	<ul>
            						<li class="active"><a href="UniversityHome.jsp">Home</a></li>
                                    <li><a href="AddCollege.jsp">Add University</a></li>
                                     <li><a href="ViewCollege.jsp">View University</a></li>
    ...
    .btn-secondary:hover {
        background-color: #5a6268;
			...
			<div class="iq_content_wrap">
				<!--About Us START-->  
			<!-- Add University Section START -->  
<section class="about-us-section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-sm-8">
                <div class="login-box">
                    <h1 class="text-center mb-4">Add<br><span>University's</span></h1>
                    <form action="AddCollege" method="post">
                        <div class="form-group">
                            <label for="collegename">University Name</label>
                            <input type="text" id="collegename" name="collegename" class="form-control" placeholder="Enter University Name" required>
                        </div>
                        <div class="form-group">
                            <label for="collegeid">University ID</label>
                            <input type="text" id="collegeid" name="collegeid" class="form-control" placeholder="Enter University ID" required>
                        </div>
                        <div class="form-group">
                            <label for="collegepwd">Password</label>
                            <input type="password" id="collegepwd" name="collegepwd" class="form-control" placeholder="Enter Password" required>
                        </div>
