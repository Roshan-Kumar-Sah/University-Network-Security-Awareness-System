    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-sm-12">
                <div class="form-box">
                    <h1 class="mb-4 text-center">College<br><span>Login</span></h1>
                    <form action="CollegeLog" method="post">
                        <div class="form-group">
                            <label for="uid" class="form-label">College ID</label>
                            <input type="text" id="uid" name="uid" class="form-input" placeholder="Enter your College ID" required />
                        </div>
                        <div class="form-group">
                            <label for="pwd" class="form-label">Password</label>
                            <input type="password" id="pwd" name="pwd" class="form-input" placeholder="Enter your Password" required />
                        </div>
