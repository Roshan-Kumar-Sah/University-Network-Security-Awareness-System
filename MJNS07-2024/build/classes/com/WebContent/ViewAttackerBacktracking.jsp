...
<head>
    ...
    .attacker-table th, .attacker-table td {
        padding: 12px;
        text-align: left;
    ...
    .attacker-table tbody tr {
        transition: background-color 0.3s;
    }

    .attacker-table tbody tr:hover {
    ...
    .text-center {
        text-align: center; /* Center text for no data message */
        color: #666; /* Gray color for no data message */
    }
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12">
                <div class="form-box">
                    <h1 class="text-center mb-4">View Attacker<br><span>Backtracking</span></h1>
                    <table class="attacker-table">
                        ...
                        <tbody>
                            <%
                                try {
                                    ResultSet r = DBConnection.getAlarmEventInfo();
                                    while (r.next()) {
                            %>
                                <tr>
                                    <td><%= r.getString(1) %></td>
                            ...
                            %>
                                <tr>
                                    <td colspan="4" class="text-center">No attackers available</td>
                                </tr>
                            <%
                                }
                            %>
