                    ...
                    <div class="iq_ui_element">
                        ...
                        <div class="navigation-wrapper pull-left">
                            <div class="navigation pull-left">
                            	<ul>
            						<li class="active"><a href="CollegeHome.jsp">Home</a></li>
                                    <li><a href="CollegeReq.jsp">College Request</a></li>
                                       <li><a href="StoreData.jsp">Store Data</a></li>
                                       <li><a href="ViewNotification.jsp">View Alert Notification</a></li>
                                         <li><a href="ViewAColleges.jsp">View Affiliated College</a></li>
...
.affiliated-colleges-table th,
.affiliated-colleges-table td {
    padding: 15px;
    text-align: left;
    border-bottom: 1px solid #dee2e6; /* Light border for rows */
}

.affiliated-colleges-table thead {
    background-color: #007bff; /* Primary color */
    color: white;
}

.affiliated-colleges-table tbody tr {
    transition: background-color 0.3s;
}

.affiliated-colleges-table tbody tr:hover {
    background-color: #e9ecef; /* Light grey on hover */
}

.affiliated-colleges-table tbody tr:nth-child(even) {
    background-color: #f9f9f9; /* Light grey for even rows */
}

.affiliated-colleges-table tbody tr:nth-child(odd) {
...
<!-- University Affiliated Colleges Section START -->
<section class="about-us-section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12">
                <div class="form-box">
                    <h1 class="mb-4 pb-0">University<br><span>Affiliated Colleges</span></h1>
                    <div class="table-responsive">
                        <table class="affiliated-colleges-table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    ResultSet r = DBConnection.getACollegeInfo(uid);
                                    while (r.next()) {
                                %>
                                <tr>
                                    <td><%= r.getString(6) %></td>
