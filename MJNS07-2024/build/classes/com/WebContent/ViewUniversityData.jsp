    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12">
                <div class="form-box">
                    <h1 class="mb-4 text-center">View University <br><span>Data</span></h1>
                    <%
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <%
                                ...
                                sql = "select * from gnit where universityname='" + university + "'";
                            ...
                            %>
                                <tr>
                                    ...
                                    <td><%= itr1.next() %></td>
                                    <td><%= itr1.next() %></td>
                                    <td><a href="ViewFile?fid=<%= university %>" class="view-file">View</a></td>
                                    <td><%= itr1.next() %></td>
                                    <td><%= itr1.next() %></td>
                                </tr>
                            <%
