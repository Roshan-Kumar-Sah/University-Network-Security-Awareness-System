...
<head>
    ...
    @media (max-width: 768px) {
        ...
        .form-label {
            font-size: 16px; /* Smaller label text on mobile */
        }
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12">
                <div class="form-box">
                    <h1 class="text-center mb-4">Alarm Processing Model<br><span>Login</span></h1>
                    <form action="AlarmModel" method="post">
                        <div class="form-group">
                            <label for="uid" class="form-label">AM ID</label>
                            <input type="text" name="uid" id="uid" class="form-control" placeholder="Enter AM ID" required />
                        </div>
                        <div class="form-group">
...
<!-- College Registration Section END -->
