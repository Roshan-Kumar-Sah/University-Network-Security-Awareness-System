    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12">
                <div class="form-box">
                    <h1 class="text-center mb-4">Store<br><span>College Data</span> Conference</h1>
                    <form action="Store" method="post" enctype="multipart/form-data">
                        <table class="table">
                            <tr>
                                <td><label for="filename" class="form-label">File Name</label></td>
                                <td><input type="text" id="filename" name="filename" class="form-input" required /></td>
                            </tr>
                            <tr>
                                <td><label for="photo" class="form-label">File</label></td>
                                <td><input type="file" id="photo" name="photo" class="form-input" required /></td>
                            </tr>
                            <tr>
                                <td colspan="2" class="text-center">
                                    <input value="Upload" class="btn btn-upload" type="submit">
                                </td>
                            </tr>
                        </table>
                    </form>
