                        ...
                        <div class="navigation-wrapper pull-left">
                            <div class="navigation pull-left">
                            	<ul>
                                    ...
                                    <li><a href="ViewAlarmEvents.jsp">View Alarm Events</a></li>
                                     <li><a href="ViewAttackerBacktracking.jsp">View Attacker Backtracking</a></li>
                                     <li><a href="SendNotification.jsp">Notify To University</a></li>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12">
                <div class="form-box">
                    <h1 class="text-center mb-4">Event<br><span>Backtracking</span></h1>
                    <form action="Notify" method="get">
                        <table class="event-table">
                            <thead>
                                <tr>
                                    <th>Attacked By</th>
                                    <th>Suspected Activity</th>
                                    <th>Attacker's University</th>
                                    <th>Victim's Name</th>
                                    <th>Notify Victims</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td><input type="text" name="attackername" placeholder="Enter Attacker Name" class="form-control" required></td>
                                    <td><input type="text" name="activityname" placeholder="Enter Activity" class="form-control" required></td>
                                    <td><input type="text" name="attackeruniversity" placeholder="Enter Attacker's University" class="form-control" required></td>
                                    <td>
                                        <select name="victimname" class="form-control" required>
