    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-sm-10">
                <div class="login-box">
                    <h1 class="text-center mb-4">University<br><span>Login</span></h1>
                    <form action="CollegeLogin" method="post">
                        <div class="form-group">
                            <label for="uid">University Name</label>
                            <input type="text" id="uid" name="uid" class="form-control" placeholder="Enter University ID" required>
                        </div>
                        <div class="form-group">
