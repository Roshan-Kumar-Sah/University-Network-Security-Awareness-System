...
<head>
    ...
    a:hover {
        color: #1e7e34; /* Darker green on hover for Accept link */
    }
</style>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12">
                <div class="login-box">
                    <h1 class="text-center mb-4">Add<br><span>College's</span></h1>
                        ...
                        <table class="table table-striped table-bordered text-white">
                            <thead class="thead-dark">
                                <thead style="color:white;">
											...
											<% 
											String university=(String)session.getAttribute("email");
											ResultSet r=DBConnection.getCollegeRequest(university);
			...
			while(r.next())
			{
					 %>
										 		<tr style="color: white;font-size: 18px;">
													...
													<td ><%= r.getString("caddress") %></td>
													<td ><%= r.getString("status1") %></td>
													<td ><a style="color: red;" href="Approve?name=<%=r.getString(1) %>">Accept</a> </td>
												</tr>
					 <%
				}
											%>
