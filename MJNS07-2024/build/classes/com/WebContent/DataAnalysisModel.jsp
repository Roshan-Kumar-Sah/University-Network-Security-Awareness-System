    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12">
                <div class="form-box">
                    <h1 class="mb-4 text-center">Data Analysis Model<br><span>Login</span></h1>
                    <form action="DataAnalysis" method="post">
                        <div class="form-group">
                            <label for="uid" class="form-label">D.A.M ID</label>
                            <input type="text" name="uid" id="uid" class="form-control" placeholder="Enter ID" required />
                        </div>
                        <div class="form-group">
