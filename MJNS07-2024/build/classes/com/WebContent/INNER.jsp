    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-sm-8">
                <div class="login-box">
                    <h1 class="text-center">Admin<br><span>Login</span></h1>
                    <form action="UniversityLogin" method="post">
                        <div class="form-group">
                            <label for="uid">U Id</label>
                            <input type="text" id="uid" name="uid" class="form-control" placeholder="Enter your U Id" required>
                        </div>
                        <div class="form-group">
